...
import { ArrowDownRight, ArrowUpRight, BookOpen, Compass, GraduationCap, Scale, Users, UserPlus, MessageSquare, Link as LinkIcon } from "lucide-react";
...
export default function Home() {
  ...
  const routes: RouteCard[] = isIndonesian
    ? [
        ...
        { number: "05", title: "Dosen & Staf", description: "Profil pengajar dan struktur pimpinan.", href: "/dosen", icon: Users },
        { number: "06", title: "Kemahasiswaan", description: "Organisasi kampus, KPS, dan aktivitas.", href: "/kemahasiswaan", icon: UserPlus },
        { number: "07", title: "Apa Kata Mereka", description: "Perspektif dan ulasan pengalaman akademik.", href: "/perspektif", icon: MessageSquare },
        { number: "08", title: "Tautan", description: "Direktori lengkap referensi resmi eksternal.", href: "/tautan", icon: LinkIcon },
      ]
    : [
        ...
        { number: "05", title: "Faculty & Staff", description: "Lecturer profiles and leadership structure.", href: "/dosen", icon: Users },
        { number: "06", title: "Student Life", description: "Campus organizations, KPS, and activities.", href: "/kemahasiswaan", icon: UserPlus },
        { number: "07", title: "What They’re Saying", description: "Perspectives and reviews of academic experience.", href: "/perspektif", icon: MessageSquare },
        { number: "08", title: "Links", description: "Complete directory of official external references.", href: "/tautan", icon: LinkIcon },
      ];
  return <>
